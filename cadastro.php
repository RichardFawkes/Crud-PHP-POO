...
<?php include_once('inc/navbar.php')?>
  ...
  <div class="container main">
      ...
      <div class="card">
      <form action="def/insert.php" method="post" >
          <div class="row">
          <div class="col-md-4">
          ...
          <input type="text" class="form-control cpfOuCnpj" name="cpf_cnpj" id="cpfOuCnpj">
          </div>
          <div class="col-md-4">
          ...
          <textarea style="resize: none;"type="text" class="form-control" name="descri_titulo" id="descri_titulo"></textarea>
          </div>
          <div class="col-md-4">
